...
/* LEGION_WAVE_56_today_counter */
try{var _dk=new Date().toDateString();var _o=JSON.parse(localStorage.getItem('lw_p2_my_panthe_today_counter')||'{}');if(_o.d!==_dk)_o={d:_dk,n:0};_o.n=(_o.n||0)+1;localStorage.setItem('lw_p2_my_panthe_today_counter',JSON.stringify(_o));}catch(e){}
...
function showPremiumModal() {
  ...
  modal.innerHTML = `
    <div style="background:#25221d;border:1px solid #c9a227;border-radius:16px;padding:20px;max-width:300px;text-align:center;">
      ...
      <div style="font-size:11px;line-height:1.4;color:#c9a227;opacity:0.95;margin:0 0 10px;padding:6px 8px;border:1px solid #c9a227;border-radius:8px;">🔒 Social creative game · In-game cosmetic only · No cash value · Non-transferable · Not gambling · No real-money gaming</div>
